...
def main(args):
    ...
    predictions = xgb_classifier.predict(X_test_counts)
    ...
    # Save the model
    joblib.dump(xgb_classifier, 'model_name.pkl')

if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="XGBoost Classifier for Text Data")
