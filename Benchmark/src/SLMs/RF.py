...
def main(args):
    ...
    predictions = rf_model.predict(X_test_counts)
    ...
    # Save the model
    joblib.dump(rf_model, 'model_name.pkl')

if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Random Forest Classifier for Text Data")
