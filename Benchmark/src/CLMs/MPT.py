...
def evaluate(y_true, y_pred):
    mapping = {
        ...
        "severe_toxic": 7, "    toxic": 6, "identity_hate": 5, "insult": 4, "obscene": 3,
        "threat": 2, "aggressive": 1, "neither": 0
    }
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Fine-tune MPT for SUD")
